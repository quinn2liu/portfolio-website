      ...
      <div className=" flex flex-col justify-between items-center sm:h-full h-screen">
        <div className="container mx-auto max-w-screen-lg sm:px-6 px-5" suppressHydrationWarning>
          ...
          <div className=" flex flex-col justify-start items-center">
              <WorkSection />
              <EducationSection />
              <a href = "/Quinn Liu Resume - Fall 2025.pdf" target="_blank" rel="noopener noreferrer" className="sm:my-12 my-8 sm:p-6 p-3  flex flex-col justify-center max-w-sm items-center border-4 dark:border-amber-100 border-gray-800 hover:underline">For more details, here's my resumé</a>
          </div>
        </div>
        <Footer />
      </div>
